...
namespace usis.Platform
{
    ...
    public class NamedValue : INamedValue
    {
        ...
        public NamedValue(string name, object value) { Name = name; Value = value; }
        ...
        public override string ToString() { return string.Format(CultureInfo.InvariantCulture, "Name = \"{0}\"; Value = '{1}'", Name, Value); }
    }
    ...
    public static class NamedValueInterfaceExtensions
    {
        ...
        public static T Get<T>(this INamedValue namedValue) { return namedValue.Get(default(T)); }
