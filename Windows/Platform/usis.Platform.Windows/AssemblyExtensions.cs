...
namespace usis.Platform
{
    ...
    public static class AssemblyExtensions
    {
        ...
        private static T GetCustomAttribute<T>(this Assembly assembly) where T : Attribute
        {
        ...
        /// <param name="assembly">The assembly.</param>
        /// <returns>
        /// The <c>HResult</c> of an exception that occurred during installation,
        ...
        /// <param name="assembly">The assembly.</param>
        /// <returns>
        /// The <c>HResult</c> of an exception that occurred during uninstallation,
