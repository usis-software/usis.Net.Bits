...
namespace usis.Framework.Portable
{
    ...
    public sealed class ExtensionCollection<TObject> : Collection<IExtension<TObject>>, IExtensionCollection<TObject>, ICollection<IExtension<TObject>>, IEnumerable<IExtension<TObject>>, IEnumerable where TObject : IExtensibleObject<TObject>
    {
