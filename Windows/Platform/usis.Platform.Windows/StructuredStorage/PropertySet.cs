...
namespace usis.Platform.StructuredStorage
{
    ...
    public sealed class PropertySet : IDisposable
    {
        ...
        internal IPropertyStorage ComInterface => storage;
        ...
        /// <i>propertyStorage</i> is a null reference (<c>Nothing</c> in Visual Basic).
        /// </exception>
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException">
        /// <i>name</i> is a null reference (<c>Nothing</c> in Visual Basic).
        /// </exception>
        ...
        public Storage GetStorage(int propertyId)
        {
            using (Property property = new Property(propertyId))
            {
                if (property.Read(storage, VarEnum.VT_STORAGE))
                {
                    ...
                    return new Storage(o as IStorage);
                }
                else return null;
            }
        }
        ...
        private class Property : IDisposable
        {
            ...
            public unsafe void* DataPointer => new IntPtr(propvars[0].Data).ToPointer();

            //  -------------
            //  Data property
            //  -------------

            public IntPtr Data => new IntPtr(propvars[0].Data);
    ...
    public class PropertySetStatistics : IStatistics
    {
        #region private fields
        ...
        public ElementType ElementType => ElementType.PropertySet;
        ...
        public Guid FormatId => statpropsetstg.FormatId;
        ...
        public Guid ClassId => statpropsetstg.ClassId;
        ...
        public PropertySetCharacteristics Characteristics => (PropertySetCharacteristics)statpropsetstg.Flags;
        ...
        public DateTime Created => statpropsetstg.Created.ToDateTime();
        ...
        public DateTime Accessed => statpropsetstg.Accessed.ToDateTime();
        ...
        public DateTime Modified => statpropsetstg.Modified.ToDateTime();
