...
namespace usis.Framework.Portable.Configuration
{
    ...
    public class ApplicationConfiguration : IApplicationConfiguration
    {
        ...
        [XmlIgnore]
        public IEnumerable<IConfigurationProperty> Properties
        {
            get { return PropertiesInternal.Cast<IConfigurationProperty>(); }
        }
        ...
        [XmlIgnore]
        public IEnumerable<ISnapInConfiguration> SnapIns
        {
            get { return SnapInsInternal.Cast<ISnapInConfiguration>(); }
        }
