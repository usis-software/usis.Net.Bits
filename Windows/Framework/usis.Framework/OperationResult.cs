...
namespace usis.Framework
{
    ...
    public class OperationResult
    {
        ...
        public bool Succeeded => ReturnCode >= 0;
        ...
        /// </summary>
        /// <param name="exception">The exception that occurred during the execution of the operation.</param>
        /// <exception cref="ArgumentNullException"><paramref name="exception" /> is a null reference, (<c>Nothing</c> in Visual Basic).</exception>
        ...
        /// <exception cref="ArgumentNullException"><paramref name="result" /> is a null reference, (<c>Nothing</c> in Visual Basic).</exception>
        ...
        /// </returns>
        /// <exception cref="ArgumentNullException"><paramref name="action" /> is a null reference, (<c>Nothing</c> in Visual Basic).</exception>
