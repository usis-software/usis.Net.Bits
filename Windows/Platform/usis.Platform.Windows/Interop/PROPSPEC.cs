...
namespace usis.Platform.Interop
{
    ...
    internal struct PROPSPEC : IDisposable
    {
        ...
        {
            if (propertyIds == null) throw new ArgumentNullException(nameof(propertyIds));
