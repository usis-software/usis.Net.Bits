...
{
    public sealed class ApnsConnection : IDisposable
    {
        static int ID = 0;
        ...
        public void Dispose()
        {
            timerBatchWait.Dispose();
            connectingSemaphore.Dispose();
            batchSendSemaphore.Dispose();
        }

        internal void Send (CompletableApnsNotification notification)
        {
        ...
        static byte[] createBatch (List<CompletableApnsNotification> toSend)
        {
        ...
        bool ValidateRemoteCertificate (object sender, X509Certificate remoteCertificate, X509Chain chain, SslPolicyErrors policyErrors)
        {
        ...
        internal class SentNotification
        {
        ...
        internal class CompletableApnsNotification
        {
