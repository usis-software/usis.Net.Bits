...
namespace usis.Framework.Configuration
{
    ...
    internal class SnapInConfigurationElement : ConfigurationElement
    {
        ...
        internal string TypeName { get { return this[type] as string; } }
        ...
        internal string AssemblyFile { get { return this[assemblyFile] as string; } }
        ...
        public PropertyConfigurationElementCollection SnapInProperties
        {
