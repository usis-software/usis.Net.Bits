...
namespace usis.Framework.Data.Entity
{
    ...
    public class DBConfiguration : DbConfiguration
    {
        ...
        /// with a configuration suitable for the specified data source.
        /// </summary>
        /// <param name="dataSource">A data source that provides the configuration information.</param>
        ...
        /// <summary>
        /// Sets the Entity Framework configuration singleton instance
        /// with a configuration suitable for the data source of the specified extension.
        /// </summary>
        /// <param name="extension">An application extension with the
        /// data source that provides the configuration information.</param>

        public static void SetDataSourceConfiguration(DataSourceApplicationExtension extension)
        {
            if (extension == null) throw new ArgumentNullException(nameof(extension));

            SetDataSourceConfiguration(extension.DataSource);
        }
