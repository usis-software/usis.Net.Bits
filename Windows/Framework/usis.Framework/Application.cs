...
namespace usis.Framework
{
    ...
    public abstract class Application<TActivator> : IApplication where TActivator : SnapInActivator, new()
    {
        ...
        private readonly HierarchicalValueStorage properties = new HierarchicalValueStorage();
        ...
        protected Application(string[] args) : this(new CommandLine(args)) { }
        ...
        protected Application(CommandLine commandLine)
        {
            if (commandLine != null) Extensions.Add(new CommandLineApplicationExtension(commandLine));
        }
        ...
        /// <exception cref="ArgumentNullException"><c>configuration</c> is a null reference (<b>Nothing</b> in Visual Basic).</exception>

        protected Application(CommandLine commandLine, IApplicationConfiguration configuration) : this(commandLine)
        {
        ...
        protected Application(params Type[] snapInTypes) : this(null, new ApplicationConfiguration(snapInTypes)) { }
        ...
        public IHierarchicalValueStorage Properties => properties;
        ...
        public IEnumerable<ISnapIn> ConnectedSnapIns => snapInHost.ConnectedSnapIns;
