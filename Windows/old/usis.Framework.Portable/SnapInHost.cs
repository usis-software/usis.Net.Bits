...
{
    #region SnapInHost<TActivator> class
    ...
    public class SnapInHost<TActivator> where TActivator : SnapInActivator, new()
    {
        ...
        public void Startup(IApplication application)
        {
            ...
            {
                IApplicationExtension solutionExtension = extension as IApplicationExtension;
        ...
        public bool Shutdown(IApplication application, bool force)
        {
            ...
            if (application.Extensions != null) application.Extensions.Clear();
    ...
    #endregion SnapInHost<TActivator> class
    ...
    public class SnapInCollectionItem
    {
        ...
        internal bool IsLoaded { get { return Instance != null; } }
        ...
        internal void Pause(IApplication application)
        {
            ...
            catch (Exception exception) { ReportException(application, exception, Strings.FailedToPauseSnapIn); }
        }
        ...
        internal void Resume(IApplication application)
        {
            ...
            catch (Exception exception) { ReportException(application, exception, Strings.FailedToResumeSnapIn); }
        }
        ...
        internal bool IsEqualInstance(ISnapIn snapIn) => Instance == snapIn;
    ...
    public abstract class SnapInHostException<TActivator> : Exception where TActivator : SnapInActivator, new()
    {
        ...
        internal SnapInHostException(SnapInHost<TActivator> host, string message, Exception innerException) :
            base(message, innerException) { Host = host; }
    ...
    /// <seealso cref="Portable.SnapInHostException{TActivator}" />
    ...
    public class ExtensionException<TActivator> : SnapInHostException<TActivator> where TActivator : SnapInActivator, new()
    {
        ...
        internal ExtensionException(
            ...
            base(host, message, innerException) { Extension = extension; }
